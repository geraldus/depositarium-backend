...
import           Handler.API.User
import           Handler.Common
import           Handler.Home
import           Handler.Manage.Currency.Create
import           Handler.Manage.Currency.List
...
makeFoundation appSettings = do
    ...
    -- Perform root user creation
    checkCreateRoot pool
...
checkCreateRoot :: ConnectionPool -> IO ()
checkCreateRoot = runSqlPool $ do
